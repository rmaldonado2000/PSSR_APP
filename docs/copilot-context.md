...
> Canonical AI context for this repo: **/docs/copilot-context.md**.  
> Rule: keep this file concise and factual; link to authoritative docs instead of duplicating them. 

## Authoritative Docs (Read Instead of Duplicating)
...
- Stack: `/docs/codebase/STACK.md`
- Testing: `/docs/codebase/TESTING.md`
- Architecture review log (if used): `/docs/architecture-review.md`
- Code-level cybersecurity compliance: `/docs/cybersecurity-compliance.md`
- Security release workflow: `/docs/security-release-process.md`
...
- Template management navigation buttons render only for users with template access; direct template-route restriction in `src/App.tsx` — Needs verification (check repo: `src/App.tsx`) 
...
- Dataverse table permissions / any server-side enforcement beyond the client app — Needs verification (not evidenced in this repo) 